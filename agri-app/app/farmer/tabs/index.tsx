    ...
    <View style={styles.container}>
      <ScrollView contentContainerStyle={styles.scroll}>
        ...
        <View style={styles.contactBox}>
          <Text style={styles.contactText}>📧 dharmlivesak@gmail.com</Text>
          <Text style={styles.contactText}>📞 +91 8232882323</Text>
          <Text style={styles.contactText}>📍 Pilibhit College, Prayagraj</Text>
        </View>
      </ScrollView>
